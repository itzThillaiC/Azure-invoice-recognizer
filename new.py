...
def analyze_invoice():
    ...
    invoiceUrl = "https://templates.invoicehome.com/invoice-template-us-neat-750px.png"
    ...
    for idx, invoice in enumerate(invoices.documents):
        ...
        billing_phone = invoice.fields.get("BillingPhone")
        if billing_phone:
            print("Billing Phone: {} ".format(billing_phone.value))
